...
public class CadastrarDoacao implements Logica {
	...
	public String executa(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Integer idMeta = Integer.parseInt(request.getParameter("txtIdMeta"));
		...
		String resultado = doacaoBO.cadastrarUsuario(idMeta, idUsuario, data, valor, mensagem, ehAnonimo, ehNotificado);
